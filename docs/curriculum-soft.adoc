...
<<<
:sectnums:
include::01-kommunikationsmodelle/00-structure.adoc[{include_configuration}]

<<<
include::02-gespraechsfuehrung/00-structure.adoc[{include_configuration}]

<<<
include::03-visualisierungstechniken/00-structure.adoc[{include_configuration}]

<<<
include::04-moderationstechniken/00-structure.adoc[{include_configuration}]

<<<
include::05-konfliktmanagement/00-structure.adoc[{include_configuration}]

<<<
include::06-reflektionstechniken/00-structure.adoc[{include_configuration}]

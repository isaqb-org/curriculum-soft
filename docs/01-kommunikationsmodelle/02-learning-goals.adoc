...
The participants recognise that typologies can lead to pigeonholing and should therefore be used with caution. At the same time, they recognise their usefulness for self-reflection and target group and needs-oriented conversations.

= https://isaqb.org[iSAQB] Advanced Level Curriculum SOFT
...
== Status
image:https://github.com/isaqb-org/curriculum-soft/workflows/CI/badge.svg?branch=master["CI"]
image:https://img.shields.io/github/last-commit/isaqb-org/curriculum-soft/master.svg["Last commit"]
...
== Content
This repository contains the iSAQB Advanced Level curriculum for SOFT in AsciiDoc.
...
----
Via SSH:
git clone git@github.com:isaqb-org/curriculum-soft.git --recursive

Via HTTPS:
git clone https://github.com/isaqb-org/curriculum-soft.git --recursive
----
--

...
image:https://img.shields.io/github/contributors/isaqb-org/curriculum-soft.svg["Contributors",link="https://github.com/isaqb-org/advanced-template/graphs/contributors"]
